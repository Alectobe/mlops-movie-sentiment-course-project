...
# 🚀 **1. Архитектура и пайплайн проекта**
...
* 4 эксперимента с разными гиперпараметрами
...
В проекте проведены 4 эксперимента:
...
| linear_svc_tfidf_v1      | 10000        | (1,2)       | linear_svc_tfidf_v1   |
